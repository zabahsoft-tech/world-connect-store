  ...
  head: () => {
    ...
    return {
      meta: [
        ...
        { title: "ABN" },
        { property: "og:title", content: "ABN" },
        { name: "twitter:title", content: "ABN" },
        { name: "description", content: "Asayesh Baskhter Navin" },
        { property: "og:description", content: "Asayesh Baskhter Navin" },
        { name: "twitter:description", content: "Asayesh Baskhter Navin" },
        { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/dfab5f5b-1c84-4f39-86d7-7f085924447d/id-preview-9a46e7a9--2859184a-8db2-499b-a042-9af03cc7e504.lovable.app-1777540851110.png" },
        { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/dfab5f5b-1c84-4f39-86d7-7f085924447d/id-preview-9a46e7a9--2859184a-8db2-499b-a042-9af03cc7e504.lovable.app-1777540851110.png" },
